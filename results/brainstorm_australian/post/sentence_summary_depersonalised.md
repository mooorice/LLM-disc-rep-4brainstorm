...
|---|---|
| Observed | **5.17** / 6 |
| Random allocation, same pooled shares | 5.46 (95% 5.23–5.67) |

Observed coverage falls **below** the null interval, so essays are somewhat more concentrated than the pooled shares alone would produce — but the effect is small. Most of the distance from 6/6 is a mechanical consequence of the imbalance reported in section 6, not an additional finding.
