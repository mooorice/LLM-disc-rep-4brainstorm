...
|---|---|---|---|---|
| A Scientific Progress | 718 | 23.1% | 76.9% | -2.3 |
| B Principled Concern | 632 | 22.3% | 77.7% | -3.1 |
| C Profound Concern | 260 | 39.2% | 60.8% | +13.8 |

**Spread: 16.9 percentage points** between C (Profound Concern, 39.2% attributed) and B (Principled Concern, 22.3%).

### By model

| Model | A | B | C |
|---|---|---|---|
| `deepseek/deepseek-v4-pro-0813` | 23.1% | 26.0% | 32.7% |
| `moonshotai/kimi-k3` | 21.5% | 16.4% | 36.9% |
| `z-ai/glm-5.2` | 24.7% | 22.7% | 54.2% |
